...
public class EngTrieSET implements Iterable<String> {
  private static final int R = 26;        // characters A-Z in ASCII
  private static final int OFFSET = 65; // character A in ASCII
  ...
  public Node get(String key) {
    ...
    while (depth < keyLength && node != null) {
